...
declare module '@polkadot/types/lookup' {
  ...
  /** @name PalletMaintenanceModeEvent (36) */
  ...
  /** @name XcmV1MultiLocation (50) */
  interface XcmV1MultiLocation extends Struct {
    readonly parents: u8;
    readonly interior: XcmV1MultilocationJunctions;
  }

  /** @name XcmV1MultilocationJunctions (51) */
  ...
  /** @name XcmV0JunctionNetworkId (54) */
  ...
  /** @name PalletIpfEvent (93) */
  interface PalletIpfEvent extends Enum {
    readonly isMinted: boolean;
    readonly asMinted: ITuple<[AccountId32, u64, H256]>;
    readonly isBurned: boolean;
    readonly asBurned: ITuple<[AccountId32, u64]>;
    readonly type: 'Minted' | 'Burned';
  }

  /** @name PalletInv4Event (94) */
  interface PalletInv4Event extends Enum {
    readonly isIpsCreated: boolean;
    readonly asIpsCreated: {
      readonly ipsAccount: AccountId32;
      readonly ipsId: u32;
      readonly assets: Vec<PalletInv4AnyId>;
    } & Struct;
    readonly isIpsDestroyed: boolean;
    readonly asIpsDestroyed: {
      readonly ipsAccount: AccountId32;
      readonly ipsId: u32;
    } & Struct;
    readonly isAppendedToIPS: boolean;
    readonly asAppendedToIPS: {
      readonly callerAccount: AccountId32;
      readonly ipsId: u32;
      readonly newMetadata: Option<Bytes>;
      readonly assets: Vec<PalletInv4AnyId>;
    } & Struct;
    readonly isRemovedFromIPS: boolean;
    readonly asRemovedFromIPS: {
      readonly callerAccount: AccountId32;
      readonly ipsId: u32;
      readonly newMetadata: Option<Bytes>;
      readonly assetsAndNewOwners: Vec<ITuple<[PalletInv4AnyId, AccountId32]>>;
    } & Struct;
    readonly isAllowedReplica: boolean;
    readonly asAllowedReplica: {
      readonly ipsId: u32;
    } & Struct;
    readonly isDisallowedReplica: boolean;
    readonly asDisallowedReplica: {
      readonly ipsId: u32;
    } & Struct;
    readonly isReplicaCreated: boolean;
    readonly asReplicaCreated: {
      readonly ipsAccount: AccountId32;
      readonly ipsId: u32;
      readonly replicaId: u32;
    } & Struct;
    readonly isMinted: boolean;
    readonly asMinted: {
      readonly token: ITuple<[u32, Option<u32>]>;
      readonly target: AccountId32;
      readonly amount: u128;
    } & Struct;
    readonly isBurned: boolean;
    ...
    readonly asMultisigVoteStarted: {
      ...
      readonly votesAdded: u128;
      readonly votesRequired: u128;
    ...
    readonly isSubTokenCreated: boolean;
    readonly asSubTokenCreated: {
      readonly subTokensWithEndowment: Vec<ITuple<[ITuple<[u32, u32]>, AccountId32, u128]>>;
    } & Struct;
    readonly isPermissionSet: boolean;
    readonly asPermissionSet: {
      readonly ipsId: u32;
      readonly subTokenId: u32;
      readonly callIndex: U8aFixed;
      readonly permission: bool;
    } & Struct;
    readonly isWeightSet: boolean;
    readonly asWeightSet: {
      readonly ipsId: u32;
      readonly subTokenId: u32;
      readonly votingWeight: InvarchPrimitivesOneOrPercent;
    } & Struct;
    readonly type: 'IpsCreated' | 'IpsDestroyed' | 'AppendedToIPS' | 'RemovedFromIPS' | 'AllowedReplica' | 'DisallowedReplica' | 'ReplicaCreated' | 'Minted' | 'Burned' | 'MultisigVoteStarted' | 'MultisigVoteAdded' | 'MultisigVoteWithdrawn' | 'MultisigExecuted' | 'MultisigCanceled' | 'SubTokenCreated' | 'PermissionSet' | 'WeightSet';
  }

  /** @name PalletInv4AnyId (96) */
  interface PalletInv4AnyId extends Enum {
    readonly isIpfId: boolean;
    readonly asIpfId: u64;
    readonly isRmrkNft: boolean;
    readonly asRmrkNft: ITuple<[u32, u32]>;
    readonly isRmrkCollection: boolean;
    readonly asRmrkCollection: u32;
    readonly isIpsId: boolean;
    readonly asIpsId: u32;
    readonly type: 'IpfId' | 'RmrkNft' | 'RmrkCollection' | 'IpsId';
  }
  ...
  /** @name TinkernetRuntimeOriginCaller (111) */
  ...
  /** @name FrameSupportScheduleMaybeHashed (132) */
  ...
  /** @name PalletMaintenanceModeCall (134) */
  ...
  /** @name PalletCollatorSelectionCall (144) */
  ...
  /** @name TinkernetRuntimeSessionKeys (146) */
  interface TinkernetRuntimeSessionKeys extends Struct {
    readonly aura: SpConsensusAuraSr25519AppSr25519Public;
  }

  /** @name SpConsensusAuraSr25519AppSr25519Public (147) */
  interface SpConsensusAuraSr25519AppSr25519Public extends SpCoreSr25519Public {}

  /** @name SpCoreSr25519Public (148) */
  interface SpCoreSr25519Public extends U8aFixed {}

  /** @name CumulusPalletXcmpQueueCall (149) */
  ...
  /** @name CumulusPalletDmpQueueCall (150) */
  ...
  /** @name PalletIdentityIdentityInfo (153) */
  ...
  /** @name PalletIdentityBitFlags (189) */
  ...
  /** @name PalletIdentityIdentityField (190) */
  ...
  /** @name PalletIpfCall (192) */
  interface PalletIpfCall extends Enum {
    ...
    readonly type: 'Mint' | 'Burn';
  }

  /** @name PalletInv4Call (193) */
  interface PalletInv4Call extends Enum {
    readonly isCreateIps: boolean;
    readonly asCreateIps: {
      readonly metadata: Bytes;
      readonly assets: Vec<PalletInv4AnyId>;
      readonly allowReplica: bool;
      readonly iplLicense: TinkernetRuntimeInvArchLicenses;
      readonly iplExecutionThreshold: InvarchPrimitivesOneOrPercent;
      readonly iplDefaultAssetWeight: InvarchPrimitivesOneOrPercent;
      readonly iplDefaultPermission: bool;
    } & Struct;
    readonly isAppend: boolean;
    readonly asAppend: {
      readonly ipsId: u32;
      readonly originalCaller: Option<AccountId32>;
      readonly assets: Vec<PalletInv4AnyId>;
      readonly newMetadata: Option<Bytes>;
    } & Struct;
    ...
    readonly asRemove: {
      readonly ipsId: u32;
      readonly originalCaller: Option<AccountId32>;
      readonly assets: Vec<ITuple<[PalletInv4AnyId, AccountId32]>>;
      readonly newMetadata: Option<Bytes>;
    } & Struct;
    readonly isAllowReplica: boolean;
    readonly asAllowReplica: {
      readonly ipsId: u32;
    } & Struct;
    readonly isDisallowReplica: boolean;
    readonly asDisallowReplica: {
      readonly ipsId: u32;
    } & Struct;
    readonly isIptMint: boolean;
    readonly asIptMint: {
      readonly iptId: ITuple<[u32, Option<u32>]>;
      readonly amount: u128;
      readonly target: AccountId32;
    } & Struct;
    readonly isIptBurn: boolean;
    readonly asIptBurn: {
      readonly iptId: ITuple<[u32, Option<u32>]>;
      readonly amount: u128;
      readonly target: AccountId32;
    ...
    readonly isCreateSubToken: boolean;
    readonly asCreateSubToken: {
      readonly ipsId: u32;
      readonly subTokens: Vec<ITuple<[InvarchPrimitivesSubIptInfo, ITuple<[AccountId32, u128]>]>>;
    } & Struct;
    ...
    readonly isSetSubTokenWeight: boolean;
    readonly asSetSubTokenWeight: {
      readonly ipsId: u32;
      readonly subTokenId: u32;
      readonly votingWeight: InvarchPrimitivesOneOrPercent;
    } & Struct;
    readonly type: 'CreateIps' | 'Append' | 'Remove' | 'AllowReplica' | 'DisallowReplica' | 'IptMint' | 'IptBurn' | 'OperateMultisig' | 'VoteMultisig' | 'WithdrawVoteMultisig' | 'CreateSubToken' | 'SetPermission' | 'SetSubTokenWeight';
  }

  /** @name TinkernetRuntimeInvArchLicenses (194) */
  interface TinkernetRuntimeInvArchLicenses extends Enum {
    readonly isApache2: boolean;
    readonly isGpLv3: boolean;
    readonly isGpLv2: boolean;
    readonly isAgpLv3: boolean;
    readonly isLgpLv3: boolean;
    readonly isMit: boolean;
    readonly isIsc: boolean;
    readonly isMpLv2: boolean;
    readonly isBsLv1: boolean;
    readonly isUnlicense: boolean;
    readonly isCc01: boolean;
    readonly isCcBy4: boolean;
    readonly isCcBySa4: boolean;
    readonly isCcByNd4: boolean;
    readonly isCcByNc4: boolean;
    readonly isCcByNcSa4: boolean;
    readonly isCcByNcNd4: boolean;
    readonly isOfl11: boolean;
    readonly isNftLicense2: boolean;
    readonly isCustom: boolean;
    readonly asCustom: ITuple<[Bytes, H256]>;
    readonly type: 'Apache2' | 'GpLv3' | 'GpLv2' | 'AgpLv3' | 'LgpLv3' | 'Mit' | 'Isc' | 'MpLv2' | 'BsLv1' | 'Unlicense' | 'Cc01' | 'CcBy4' | 'CcBySa4' | 'CcByNd4' | 'CcByNc4' | 'CcByNcSa4' | 'CcByNcNd4' | 'Ofl11' | 'NftLicense2' | 'Custom';
  }

  /** @name InvarchPrimitivesOneOrPercent (196) */
  interface InvarchPrimitivesOneOrPercent extends Enum {
    readonly isOne: boolean;
    readonly isZeroPoint: boolean;
    readonly asZeroPoint: Percent;
    readonly type: 'One' | 'ZeroPoint';
  }

  /** @name InvarchPrimitivesSubIptInfo (200) */
  interface InvarchPrimitivesSubIptInfo extends Struct {
    readonly id: u32;
    readonly metadata: Bytes;
  }

  /** @name PalletRmrkCoreCall (202) */
  ...
  /** @name RmrkTraitsResourceResourceInfoMin (208) */
  interface RmrkTraitsResourceResourceInfoMin extends Struct {
    readonly id: u32;
    readonly resource: RmrkTraitsResourceResourceTypes;
  }

  /** @name RmrkTraitsResourceResourceTypes (211) */
  ...
  /** @name RmrkTraitsResourceBasicResource (212) */
  interface RmrkTraitsResourceBasicResource extends Struct {
    readonly metadata: Bytes;
  }

  /** @name RmrkTraitsResourceComposableResource (213) */
  ...
  /** @name RmrkTraitsResourceSlotResource (215) */
  ...
  /** @name RmrkTraitsNftAccountIdOrCollectionNftTuple (218) */
  ...
  /** @name RmrkTraitsPartEquippableList (223) */
  ...
  /** @name RmrkTraitsThemeThemeProperty (227) */
  ...
  /** @name OrmlVestingVestingSchedule (247) */
  ...
  /** @name OrmlVestingModuleEvent (255) */
  ...
  /** @name FrameSystemLastRuntimeUpgradeInfo (259) */
  interface FrameSystemLastRuntimeUpgradeInfo extends Struct {
    readonly specVersion: Compact<u32>;
    readonly specName: Text;
  }

  /** @name FrameSystemLimitsBlockWeights (261) */
  ...
  /** @name FrameSupportWeightsPerDispatchClassWeightsPerClass (262) */
  ...
  /** @name FrameSystemLimitsWeightsPerClass (263) */
  ...
  /** @name FrameSystemLimitsBlockLength (265) */
  interface FrameSystemLimitsBlockLength extends Struct {
    readonly max: FrameSupportWeightsPerDispatchClassU32;
  }

  /** @name FrameSupportWeightsPerDispatchClassU32 (266) */
  ...
  /** @name FrameSupportWeightsRuntimeDbWeight (267) */
  interface FrameSupportWeightsRuntimeDbWeight extends Struct {
    readonly read: u64;
    readonly write: u64;
  }

  /** @name SpVersionRuntimeVersion (268) */
  ...
  /** @name PolkadotPrimitivesV2UpgradeRestriction (275) */
  ...
  /** @name PolkadotPrimitivesV2AbridgedHrmpChannel (279) */
  ...
  /** @name PolkadotPrimitivesV2AbridgedHostConfiguration (280) */
  ...
  /** @name CumulusPalletParachainSystemError (287) */
  ...
  /** @name PalletMaintenanceModeError (296) */
  ...
  /** @name PalletBalancesReleases (304) */
  ...
  /** @name PalletTransactionPaymentReleases (307) */
  ...
  /** @name PalletTreasuryProposal (308) */
  ...
  /** @name PalletAuthorshipError (316) */
  ...
  /** @name PalletCollatorSelectionCandidateInfo (319) */
  ...
  /** @name SpCoreCryptoKeyTypeId (325) */
  interface SpCoreCryptoKeyTypeId extends U8aFixed {}

  /** @name PalletSessionError (326) */
  ...
  /** @name PolkadotParachainPrimitivesXcmpMessageFormat (335) */
  ...
  /** @name InvarchPrimitivesIpfInfo (364) */
  interface InvarchPrimitivesIpfInfo extends Struct {
    readonly owner: AccountId32;
  ...
  /** @name PalletIpfError (367) */
  interface PalletIpfError extends Enum {
    readonly isNoAvailableIpfId: boolean;
    readonly isIpfNotFound: boolean;
    readonly isNoPermission: boolean;
    readonly isMaxMetadataExceeded: boolean;
    readonly type: 'NoAvailableIpfId' | 'IpfNotFound' | 'NoPermission' | 'MaxMetadataExceeded';
  }

  /** @name InvarchPrimitivesIpInfo (368) */
  interface InvarchPrimitivesIpInfo extends Struct {
    readonly parentage: InvarchPrimitivesParentage;
    readonly metadata: Bytes;
    readonly data: Vec<PalletInv4AnyId>;
    readonly ipsType: InvarchPrimitivesIpsType;
    readonly allowReplica: bool;
    readonly supply: u128;
    readonly license: ITuple<[Bytes, H256]>;
    readonly executionThreshold: InvarchPrimitivesOneOrPercent;
    readonly defaultAssetWeight: InvarchPrimitivesOneOrPercent;
    readonly defaultPermission: bool;
  }

  /** @name InvarchPrimitivesParentage (370) */
  interface InvarchPrimitivesParentage extends Enum {
    readonly isParent: boolean;
    readonly asParent: AccountId32;
    readonly isChild: boolean;
    readonly asChild: ITuple<[u32, AccountId32]>;
    readonly type: 'Parent' | 'Child';
  }

  /** @name InvarchPrimitivesIpsType (371) */
  interface InvarchPrimitivesIpsType extends Enum {
    readonly isNormal: boolean;
    readonly isReplica: boolean;
    readonly asReplica: u32;
    readonly type: 'Normal' | 'Replica';
  }

  /** @name PalletInv4IptMultisigOperation (375) */
  interface PalletInv4IptMultisigOperation extends Struct {
    readonly signers: Vec<ITuple<[AccountId32, Option<u32>]>>;
    readonly includeOriginalCaller: bool;
    readonly originalCaller: AccountId32;
    readonly actualCall: WrapperKeepOpaque<Call>;
    readonly callMetadata: U8aFixed;
    readonly callWeight: u64;
  }

  /** @name PalletInv4Error (381) */
  interface PalletInv4Error extends Enum {
    readonly isNoAvailableIpId: boolean;
    readonly isIpfNotFound: boolean;
    readonly isIpsNotFound: boolean;
    readonly isNoPermission: boolean;
    readonly isAlreadyOwned: boolean;
    readonly isMaxMetadataExceeded: boolean;
    readonly isCannotDestroyIps: boolean;
    readonly isNotParent: boolean;
    readonly isReplicaCannotAllowReplicas: boolean;
    readonly isValueNotChanged: boolean;
    readonly isReplicaNotAllowed: boolean;
    readonly isIpDoesntExist: boolean;
    readonly isNotEnoughAmount: boolean;
    readonly isTooManySignatories: boolean;
    readonly isUnexistentBalance: boolean;
    readonly isMultisigOperationUninitialized: boolean;
    readonly isCouldntDecodeCall: boolean;
    readonly isMultisigOperationAlreadyExists: boolean;
    readonly isNotAVoter: boolean;
    readonly isUnknownError: boolean;
    readonly isSubAssetNotFound: boolean;
    readonly isSubAssetAlreadyExists: boolean;
    readonly isTooManySubAssets: boolean;
    readonly isSubAssetHasNoPermission: boolean;
    readonly isFailedDivision: boolean;
    readonly isCallHasTooFewBytes: boolean;
    readonly isIpsInsideIpsDisabled: boolean;
    readonly isWasmPermissionsDisabled: boolean;
    readonly isCantExecuteThisCall: boolean;
    readonly isInvalidWasmPermission: boolean;
    readonly isWasmPermissionFailedExecution: boolean;
    readonly isDivisionByZero: boolean;
    readonly type: 'NoAvailableIpId' | 'IpfNotFound' | 'IpsNotFound' | 'NoPermission' | 'AlreadyOwned' | 'MaxMetadataExceeded' | 'CannotDestroyIps' | 'NotParent' | 'ReplicaCannotAllowReplicas' | 'ValueNotChanged' | 'ReplicaNotAllowed' | 'IpDoesntExist' | 'NotEnoughAmount' | 'TooManySignatories' | 'UnexistentBalance' | 'MultisigOperationUninitialized' | 'CouldntDecodeCall' | 'MultisigOperationAlreadyExists' | 'NotAVoter' | 'UnknownError' | 'SubAssetNotFound' | 'SubAssetAlreadyExists' | 'TooManySubAssets' | 'SubAssetHasNoPermission' | 'FailedDivision' | 'CallHasTooFewBytes' | 'IpsInsideIpsDisabled' | 'WasmPermissionsDisabled' | 'CantExecuteThisCall' | 'InvalidWasmPermission' | 'WasmPermissionFailedExecution' | 'DivisionByZero';
  }

  /** @name PalletUniquesCollectionDetails (382) */
  ...
  /** @name PalletUniquesItemDetails (384) */
  ...
  /** @name PalletUniquesCollectionMetadata (385) */
  ...
  /** @name PalletUniquesItemMetadata (386) */
  ...
  /** @name RmrkTraitsCollectionCollectionInfo (390) */
  ...
  /** @name RmrkTraitsNftRoyaltyInfo (393) */
  interface RmrkTraitsNftRoyaltyInfo extends Struct {
    readonly recipient: AccountId32;
    readonly amount: Permill;
  }

  /** @name RmrkTraitsResourceResourceInfo (396) */
  ...
  /** @name RmrkTraitsBaseBaseInfo (404) */
  ...
  /** @name OrmlVestingModuleError (410) */
  ...
  /** @name TinkernetRuntimeRuntime (428) */
